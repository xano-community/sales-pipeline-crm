...
query "board" verb=GET {
  ...
  stack {
    ...
    foreach ($stages) {
      ...
      each as $s {
        group {
          description = "Enrich this pipeline column with its deal cards and alerts"
          stack {
            db.query "deal" {
...
query "deals/{deal_id}/advance" verb=POST {
  ...
  stack {
    ...
    function.run "deals/advance_deal" {
...
query "seed" verb=POST {
  ...
  stack {
    ...
    group {
      description = "Seed the pipeline stages"
      stack {
        var $stages {
    ...
    group {
      description = "Seed the demo users"
      stack {
        var $users {
    ...
    group {
      description = "Seed the demo accounts"
      stack {
        var $accounts {
    ...
    group {
      description = "Seed the demo contacts"
      stack {
        var $contacts {
    ...
    // --- Leads ---
    group {
      description = "Seed the demo leads"
      stack {
        var $leads {
    ...
    // --- Deals ---
    group {
      description = "Seed the demo deals"
      stack {
        var $deals {
    ...
    group {
      description = "Seed the demo activities"
      stack {
        var $activities {
    ...
    group {
      description = "Seed the opportunity contact roles"
      stack {
        var $roles {
